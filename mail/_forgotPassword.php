    ...
    <div style="margin: 0 auto; max-width: 600px; padding: 3rem; border-radius: 10px; background-color: white; border: 1px solid #f2f3f4; font-family: 'Poppins', sans-serif;">
        <div style="text-align: center;">
            ...
            <p style="font-size: 14px; line-height: 20px; color: #4f5660; display: block;" class="text-muted">
                Hi <b><?= $username ?></b>, <br>
                We got a request to reset your Readme account password.
            </p>

            <a href="<?= Url::to(['site/reset-password', 'token' => $token, 'isAuthorized' => true], true) ?>" style="text-decoration: none; background-color: #e67373; color: white; padding: 10px 20px; border-radius: 5px; text-align: center; display: inline-block; margin-top: 1rem;">
                Reset Password
            </a>
